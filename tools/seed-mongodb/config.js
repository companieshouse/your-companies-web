const mongodbConfigs = {
    ...
    cidev: "mongodb+srv://phoenix_dev@ci-dev-pl-0.ueium.mongodb.net /admin?retryWrites=true&loadBalanced=false&replicaSet=atlas-yar7m5-shard-0&readPreference=primary&srvServiceName=mongodb&connectTimeoutMS=10000&authSource=admin&authMechanism=SCRAM-SHA-1"
};
...
export const NO_COMPANIES_TO_CREATE = 10;
