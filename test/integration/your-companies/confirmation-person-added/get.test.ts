...
import en from "../../../../locales/en/confirmation-person-added.json";
import cy from "../../../../locales/cy/confirmation-person-added.json";
...
describe("GET /your-companies/confirmation-person-added", () => {
    const url = "/your-companies/confirmation-person-added";

    beforeEach(() => {
        jest.clearAllMocks();
    });

    it("should check session and auth before returning the person added confirmation page", async () => {
        // When
