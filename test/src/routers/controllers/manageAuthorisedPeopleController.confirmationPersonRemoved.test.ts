...
describe("GET /your-companies/manage-authorised-people/:companyNumber/confirmation-person-removed", () => {
    ...
    it("should return expected English content if person already removed, their name not provided and language version set to English", async () => {
        // Given
        const removal: Removal = {
            removePerson: CONFIRM,
            userEmail: companyAssociations.items[1].userEmail,
    ...
    it("should return expected Welsh content if person already removed, their name not provided and language version set to Welsh", async () => {
        // Given
        const removal: Removal = {
            removePerson: CONFIRM,
            userEmail: companyAssociations.items[1].userEmail,
