import { ConfirmationPersonsDigitalAuthorisationCancelledHandler } from "../../../../../../src/routers/handlers/yourCompanies/confirmationPersonsDigitalAuthorisationCancelledHandler";
...
describe("ConfirmationPersonsDigitalAuthorisationCancelledHandler", () => {
    let confirmationPersonsDigitalAuthorisationCancelledHandler: ConfirmationPersonsDigitalAuthorisationCancelledHandler;

    beforeEach(() => {
        jest.clearAllMocks();
        jest.resetAllMocks();
        confirmationPersonsDigitalAuthorisationCancelledHandler = new ConfirmationPersonsDigitalAuthorisationCancelledHandler();
    });
    ...
    test.each([
        ...
        async ({ lang }) => {
            ...
            getExtraDataSpy.mockReturnValueOnce(personRemovedConfirmationData);
            ...
            // When
            const response = await confirmationPersonsDigitalAuthorisationCancelledHandler.execute(req);
            // Then
            ...
            expect(getTranslationsForViewSpy).toHaveBeenCalledWith(lang, constants.CONFIRMATION_PERSONS_DIGITAL_AUTHORISATION_CANCELLED_PAGE);
