...
export const REMOVE_COMPANY_CONFIRMED_FULL_URL = `${LANDING_URL}/${REMOVE_COMPANY_CONFIRMED}`;
...
export const YOUR_COMPANIES_REMOVE_COMPANY_URL = `${LANDING_URL}/${REMOVE_COMPANY_PAGE}/:${COMPANY_NUMBER}`;
