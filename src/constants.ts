...
export const BEFORE_ADD_PRESENTER_URL = `/before-add-presenter/:${COMPANY_NUMBER}`;
export const YOUR_COMPANIES_ADD_PRESENTER_URL = LANDING_URL + ADD_PRESENTER_URL;
export const YOUR_COMPANIES_BEFORE_ADD_PRESENTER_URL = LANDING_URL + BEFORE_ADD_PRESENTER_URL;
