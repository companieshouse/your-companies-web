...
export const NAVIGATION_MIDDLEWARE_FLAG_FOR_COMPANY_AUTHENTICATION_SERVICE_COMPANY_ADDED_SUCCESS = "navigationMiddlewareFlagForCompanyAuthenticationServiceCompanyAddedSuccess";
export const NAVIGATION_MIDDLEWARE_FLAG_FOR_COMPANY_AUTHENTICATION_SERVICE_RESTORE_YOUR_DIGITAL_AUTHORISATION_SUCCESS = "navigationMiddlewareFlagForCompanyAuthenticationServiceRestoreYourDigitalAuthorisationSuccess";
export const NAVIGATION_MIDDLEWARE_FLAG_FOR_COMPANY_AUTHENTICATION_SERVICE_COMPANY_AUTH_PROTECTED_AUTHENTICATION_CODE_REMOVE = "navigationMiddlewareFlagForCompanyAuthenticationServiceAuthenticationCodeRemove";
// query params
...
export const CONFIRMATION_PERSON_REMOVED_PAGE = "confirmation-persons-authorisation-removed";
...
export const COMPANY_ADDED_SUCCESS_URL = `${COMPANY_AUTH_PROTECTED_BASE}/${COMPANY_ADD_SUCCESS_PAGE}`;
...
export const CONFIRMATION_AUTHORISATION_EMAIL_RESENT_URL = `/${CONFIRMATION_AUTHORISATION_EMAIL_RESENT_PAGE}`;
...
export const RESTORE_YOUR_DIGITAL_AUTHORISATION_SUCCESS_PARTIAL_URL = `/${RESTORE_YOUR_DIGITAL_AUTHORISATION_SUCCESS_PAGE}`;
export const RESTORE_YOUR_DIGITAL_AUTHORISATION_SUCCESS_URL = `${COMPANY_AUTH_PROTECTED_BASE}/${RESTORE_YOUR_DIGITAL_AUTHORISATION_SUCCESS_PAGE}`;
...
export const CONFIRMATION_PERSONS_DIGITAL_AUTHORISATION_REMOVED_NOT_RESTORED_URL = `/${CONFIRMATION_PERSONS_DIGITAL_AUTHORISATION_REMOVED_NOT_RESTORED_PAGE}`;
...
export const MATOMO_GOALS = {
    MATOMO_ADD_COMPANY_GOAL_ID: process.env.MATOMO_ADD_COMPANY_GOAL_ID,
    MATOMO_REMOVE_CONFIRMED_COMPANY_GOAL_ID: process.env.MATOMO_REMOVE_CONFIRMED_COMPANY_GOAL_ID,
    MATOMO_RESTORE_MIGRATED_OR_UNAUTHORISED_COMPANY_GOAL_ID: process.env.MATOMO_RESTORE_MIGRATED_OR_UNAUTHORISED_COMPANY_GOAL_ID,
    MATOMO_REMOVE_MIGRATED_OR_UNAUTHORISED_COMPANY_GOAL_ID: process.env.MATOMO_REMOVE_MIGRATED_OR_UNAUTHORISED_COMPANY_GOAL_ID,
    MATOMO_ADD_NEW_AUTHORISED_PERSON_GOAL_ID: process.env.MATOMO_ADD_NEW_AUTHORISED_PERSON_GOAL_ID,
    MATOMO_REMOVE_YOURSELF_GOAL_ID: process.env.MATOMO_REMOVE_YOURSELF_GOAL_ID,
    MATOMO_REMOVE_CONFIRMED_PERSON_GOAL_ID: process.env.MATOMO_REMOVE_CONFIRMED_PERSON_GOAL_ID,
    MATOMO_REMOVE_AWAITING_APPROVAL_PERSON_GOAL_ID: process.env.MATOMO_REMOVE_AWAITING_APPROVAL_PERSON_GOAL_ID,
    MATOMO_REMOVE_MIGRATED_OR_UNAUTHORISED_PERSON_GOAL_ID: process.env.MATOMO_REMOVE_MIGRATED_OR_UNAUTHORISED_PERSON_GOAL_ID,
    MATOMO_RESTORE_MIGRATED_OR_UNAUTHORISED_PERSON_GOAL_ID: process.env.MATOMO_RESTORE_MIGRATED_OR_UNAUTHORISED_PERSON_GOAL_ID
};
