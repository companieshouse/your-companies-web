...
export const YOUR_COMPANIES_COMPANY_INVITATIONS_ACCEPT_URL = ADD_COMPANY_URL + COMPANY_INVITATIONS_ACCEPT_URL;
export const COMPANY_INVITATIONS_DECLINE_URL = `/${COMPANY_INVITATIONS_DECLINE_PAGE}/:${ASSOCIATIONS_ID}`;
export const YOUR_COMPANIES_COMPANY_INVITATIONS_DECLINE_URL = ADD_COMPANY_URL + COMPANY_INVITATIONS_DECLINE_URL;
