...
router.get(constants.RESTORE_YOUR_DIGITAL_AUTHORISATION_SUCCESS_URL, companyAuthenticationMiddleware, navigationMiddleware, confirmationYourDigitalAuthorisationRestoredControllerGet);
