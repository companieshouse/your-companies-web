...
export enum AssociationState {
    ...
    COMPANY_MIGRATED_NOT_YET_ASSOCIATED_WITH_USER = "COMPANY_MIGRATED_NOT_YET_ASSOCIATED_WITH_USER",
    COMPANY_UNAUTHORISED_NOT_YET_ASSOCIATED_WITH_USER = "COMPANY_UNAUTHORISED_NOT_YET_ASSOCIATED_WITH_USER"
}
...
export type AssociationStateWithId = {
    ...
    AssociationState.COMPANY_MIGRATED_NOT_YET_ASSOCIATED_WITH_USER |
    AssociationState.COMPANY_UNAUTHORISED_NOT_YET_ASSOCIATED_WITH_USER;
